...
function skeletonize_images(input_dir, target_dir)
    ...
    %matlab -batch "skeletonize_images('/lab_data/behrmannlab/image_sets/masked-ecoset/val/0001_man','/lab_data/behrmannlab/image_sets/skeletonized-ecoset/val/0001_man')"
